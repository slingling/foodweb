...
<html>
  <head>
	...
	<meta http-equiv="Refresh" content="5;url=food/food_showFood">
  ...
  <body>
   <s:form action="food/food_showFood" method="post">  
     ...
     <table border="0" style="float:left;">
						<tr>
							<td rowspan="4" width="240" align="center"><img src="/foodweb/photos/food_image/${food.imagepath}" width="200" height="150"></td>
							<td height="40">名称：<a href="food/food_showDetail?food.foodid=${food.foodid}"><c:out value="${food.foodname}"></c:out></td>
